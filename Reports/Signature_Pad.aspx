<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Signature_Pad.aspx.cs" Inherits="BigMac.Reports.Signature_Pad" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function onSave() {
            ...
            var fileName = getParameterByName("signFileName");
            ...
            xhr.open('POST', "/Report/UploadSignImage", true);
            xhr.send(formData);
            window.close();
        }
...
<body>
           ...
           <table border="1" cellpadding="0"  width="200">
                <tr>
                    <td height="100" class="auto-style1">
                        <canvas id="cnv" name="cnv" width="150" height="120"></canvas>
                    </td>
                </tr>
    ...
    <form id="form1" runat="server">
        <p>
            ...
            <input id="button3" name="SaveBtn" type="button" value="Save" onclick="javascript: onSave()"/>&nbsp;&nbsp;
        </p>
    </form>
</body>
</html>
